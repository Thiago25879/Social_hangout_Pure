...
<%
    ...
    if (request.getMethod().equals("POST")) {
        ...
        obj.setConevcodigo(Integer.parseInt(request.getParameter("txtCodigo")));
...
<div class="card mb-3">
    <div class="card-header">
        <i class="fa fa-pencil"></i> Edição de convite para evento</div>
    ...
    <form action="#" method="post" >
        ...
        <div class="col-lg-6">
            ...
            <div class="form-group">
                <label>Id</label>
                <input class="form-control" type="text" readonly name="txtCodigo" value="<%=obj.getConevcodigo()%>"  />
            </div>
            <div class="form-group">
                <label>Resposta</label>
                <input class="form-control" type="text" name="txtNome" required value="<%=obj.getConevresposta()%>"/>
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="../edicoes/conviteev.jsp?codigo=<%=obj.getConevcodigo()%>" type="button" class="btn btn-primary" >Corrigir edição</a>
